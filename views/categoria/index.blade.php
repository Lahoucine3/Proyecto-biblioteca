...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><?= $valor['fecha_modificación']; ?></td>
        ...
        <td>
            <a class="btn btn-danger btn-sm" onClick="return confirm('¿ Desea borrar el libro ?')" href="borrar.php?id_categoria=<?= $valor['id_categoria'] ?>">
